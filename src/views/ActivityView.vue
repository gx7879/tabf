<template>
  <div class="flex gap-10 p-10 max-w-[1440px] mx-auto">
    <div class="w-[330px]">
      <h2 class="text-lg font-semibold text-font-black">2024 第一季數位鑑識競賽</h2>
      <span class="text-sm mb-3 block text-font-black">2023/3/31 (五) 14:00 ~ 18:00，競賽倒數</span>
      <div class="bg-white py-4 mb-10 flex">
        <vue3-flip-countdown :flipAnimation="false" :showDays="false" :labels="{ hours: 'HOURS', minutes: 'MINUTES', seconds: 'SECONDS' }" mainColor="#fff" labelColor="#fff"
      ...
      <div class="space-y-1">
        <div class="flex gap-1">
          ...
          <div class="rounded-xl bg-white px-4 py-2 flex flex-1 items-center gap-2 justify-between font-semibold">
            <div class="text-primary-medium">123</div>
            <div class="text-lg flex-shrink-0 basis-auto text-success-medium">
              123 分
            </div>
          </div>
        </div>
      ...
      <div class="rounded-xl p-4 text-sm font-medium bg-white space-y-1 mb-10">
    ...
    <div class="flex-1">
      <div class="px-3 py-4 bg-notice-blue rounded-md mb-3 border border-notice-border-blue flex items-start gap-x-2">
        <img src="@/assets/images/notice-icon.png" alt="">公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告
      </div>
      ...
      <div class="shadow-[0_4px_24px_0_rgba(30,50,50,0.12)] rounded-lg overflow-hidden">
        <div class="flex px-6 py-4 gap-[15px] bg-white border-b border-light-gray" :class="{'bg-main': start}">
          <input v-model="answer" type="text" placeholder="請輸入答案 ..." class="bg-light-gray rounded pl-3 flex-1 border-[#DEE2EB] focus:border-primary-dark focus:ring-primary-dark" />
...
.countdown-style {
  ...
  :deep(.flip-clock__piece) {
    @apply bg-main text-white font-normal min-w-24 rounded-3xl px-2 py-3;
  }
